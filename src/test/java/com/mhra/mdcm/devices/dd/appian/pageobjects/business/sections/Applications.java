...
public class Applications extends _Page {
    ...
    List<WebElement> listOfApplications;
    ...
    public boolean isItemsDisplayed(String expectedHeadings) {
        WaitUtils.isPageLoadingComplete(driver, TIMEOUT_PAGE_LOAD);
        WaitUtils.waitForElementToBeClickable(driver, By.xpath(".//div[contains(text(),'Application ')]//following::a") , TIMEOUT_5_SECOND, false);
        boolean itemsDisplayed = listOfApplications.size() > 0;
